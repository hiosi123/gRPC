...
const file_calculator_proto_rawDesc = "" +
	...
	"calculator\x1a\tsum.proto\x1a\vprime.proto\x1a\tavg.proto\x1a\tmax.proto\x1a\n" +
	"sqrt.proto2\xcc\x02\n" +
	"\x11CalculatorService\x126\n" +
	"\x03Sum\x12\x16.calculator.SumRequest\x1a\x17.calculator.SumResponse\x12A\n" +
	"\bGetPrime\x12\x18.calculator.PrimeRequest\x1a\x19.calculator.PrimeResponse0\x01\x12;\n" +
	"\x06GetAvg\x12\x16.calculator.AvgRequest\x1a\x17.calculator.AvgResponse(\x01\x12D\n" +
	"\rGetCurrentMax\x12\x16.calculator.MaxRequest\x1a\x17.calculator.MaxResponse(\x010\x01\x129\n" +
	"\x04Sqrt\x12\x17.calculator.SqrtRequest\x1a\x18.calculator.SqrtResponseB+Z)github.com/hiosi123/gRPC/calculator/protob\x06proto3"
...
var file_calculator_proto_depIdxs = []int32{
	...
	1, // 1: calculator.CalculatorService.GetPrime:input_type -> calculator.PrimeRequest
	2, // 2: calculator.CalculatorService.GetAvg:input_type -> calculator.AvgRequest
	3, // 3: calculator.CalculatorService.GetCurrentMax:input_type -> calculator.MaxRequest
	...
	6, // 6: calculator.CalculatorService.GetPrime:output_type -> calculator.PrimeResponse
	7, // 7: calculator.CalculatorService.GetAvg:output_type -> calculator.AvgResponse
	8, // 8: calculator.CalculatorService.GetCurrentMax:output_type -> calculator.MaxResponse
